...
namespace WeatherAnalysis
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.BackgroundImage = Image.FromFile(@"..\\..\\Images\\cloud_bg_1.jpg");
            ...
            this.pictureBox7.MouseEnter += new EventHandler(pictureBox7_MouseEnter);
            this.pictureBox7.MouseLeave += new EventHandler(pictureBox7_MouseLeave);
            this.pictureBox9.MouseEnter += new EventHandler(pictureBox9_MouseEnter);
            this.pictureBox9.MouseLeave += new EventHandler(pictureBox9_MouseLeave);
        ...
        {
            this.pictureBox9.BackColor = Color.Blue;
        }
        ...
        {
            this.pictureBox7.BackColor = Color.IndianRed;
        }
        ...
        void Form1_Load(object sender, EventArgs e)
        {
            ...
            using (Graphics dpi = this.CreateGraphics())
            {
                if (dpi.DpiX >= 120)
                {
                    ...
                    size_changed = true;
                    this.pictureBox7.Size = new Size(27, 30);
                    this.pictureBox9.Size = new Size(27, 30);
        ...
        void Form1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (e.Location.Y == 0)
            {
                this.panel8.Location = loc2;
                this.panel8.Size = new Size(rect.Width, this.panel8.Height);
                this.pictureBox7.Location = new Point(rect.Width - 27, 1);
                this.pictureBox8.Location = new Point(1, 0);
                this.pictureBox9.Location = new Point(rect.Width - 55, 1);
                this.label10.Location = new Point(rect.Width / 2 - label10.Width / 2, 2);
        ...
        private void pictureBox5_Click(object sender, EventArgs e)
        {
            ...
            Rectangle rect = Screen.GetBounds(this);
            int a = this.HorizontalScroll.Maximum / 3;
            if (this.AutoScrollPosition.X <= -a)
            {
                this.ActiveControl = this.chartControl1;
                this.chartControl1.Focus();
                this.AutoScrollPosition = new Point(this.HorizontalScroll.Maximum, this.AutoScrollPosition.Y);
            }
            else
            {
                this.HorizontalScroll.Value = a;
                this.ActiveControl = this.gridGroupingControl1;
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                this.gridGroupingControl1.Focus();
                this.ActiveControl = this.gridGroupingControl1;
                this.AutoScrollPosition = new Point(a, this.AutoScrollPosition.Y);
            }
